...
describe('HTML', () => {
  ...
  test('HTML 4: Anchor with block elements', async () => {
    ...
    assert.strictEqual(await minify(input, { html5: false }), '<a href="#"><div>Well, look at me! I\'m a div!</div>');
    assert.strictEqual(await minify(input, { html5: false, includeAutoGeneratedTags: true }), '<a href="#"></a><div>Well, look at me! I\'m a div!</div>');
  });
  ...
  test('Phrasing content', async () => {
    ...
    assert.strictEqual(await minify(input, { html5: true, includeAutoGeneratedTags: true }), '<p>a</p><div>b</div>');
    assert.strictEqual(await minify(input, { html5: false, includeAutoGeneratedTags: true }), '<p>a<div>b</div></p>');
  ...
  test('`ul` and `ol` should be phrasing content', async () => {
    ...
    assert.strictEqual(await minify(input, { html5: true }), output);
    assert.strictEqual(await minify(input, { html5: true, includeAutoGeneratedTags: true }), '<p>a</p><ul><li>item</li></ul>');
    ...
    assert.strictEqual(await minify(input, { includeAutoGeneratedTags: true, html5: true, removeEmptyElements: true }), output);
  });
