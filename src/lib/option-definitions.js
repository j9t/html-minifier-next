...
const optionDefinitions = {
  ...
  ignoreCustomFragments: {
    description: 'Array of regexes that allow to ignore certain fragments, when matched (e.g., `<?php \u2026 ?>`, `{{ \u2026 }}`, etc.)',
    type: 'regexpArray'
  },
  ...
  minifySVG: {
    description: 'Minify SVG elements (uses SVGO or—experimental—OXVG; pass `{"engine": "oxvg"}` for OXVG)',
    type: 'jsonObject'
  },
  minifyURLs: {
