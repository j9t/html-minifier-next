...
const defaultOptions = [
  ...
  },
  {
    ...
    helpText: `Collapse whitespace more aggressively between inline elements—use with <code>collapseWhitespace</code>`,
    unsafe: true
  },
  {
  ...
  },
  {
    ...
    helpText: 'Array of regexes that allow to support custom attribute assign expressions (example: <code>\\?=</code> for <code>flex?="{{mode}}"</code>)',
    value: ''
  },
  {
    id: 'customAttrCollapse',
    type: 'text',
    label: 'Custom attribute collapse',
    helpText: 'Regex that specifies custom attribute to strip newlines from (example: <code>ng-class</code>)',
    value: ''
  },
  {
    id: 'decodeEntities',
  ...
  {
    id: 'ignoreCustomComments',
    type: 'text',
    label: 'Ignore custom comments',
    helpText: 'Array of regexes that allow to ignore matching comments (example: <code>^\\s*ko</code> for Knockout.js; defaults: <code>^!</code> and <code>^\\s*#</code>)',
    value: ''
  },
  {
  ...
  {
    id: 'inlineCustomElements',
    type: 'text',
    label: 'Inline custom elements',
    helpText: 'Array of names of custom elements which are inline, for whitespace handling (example: <code>my-button, my-icon</code>)',
    value: ''
  },
  {
    id: 'keepClosingSlash',
  ...
  },
  {
    ...
    helpText: 'Array of strings corresponding to types of <code>script</code> elements to process through minifier (examples: <code>text/ng-template</code>, <code>text/x-handlebars-template</code>, etc.)',
    value: 'text/html'
  },
  {
    id: 'quoteCharacter',
  ...
  },
  {
    ...
    helpText: 'List of elements to preserve when `removeEmptyElements` is enabled (examples: <code>td, &lt;span aria-hidden=\'true\'&gt;</code>)',
    value: ''
  },
  {
