...
| --- | --- | --- |
| `--here` | Minify all HTML files in the current folder and its subfolders in place, using comprehensive settings (standalone—flag is ignored when combined with other options) | `html-minifier-next --here` |
