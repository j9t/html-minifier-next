...
| `--file-ext <extensions>`, `-f <extensions>` | Specify file extension(s) to process (comma-separated, overrides config file setting); defaults to `html,htm,xhtml,xht,shtml,shtm`; use `*` for all files | `--file-ext=html,php`, `--file-ext='*'` |
