...
* `sourceMap`: Boolean to generate source maps (default: `false`)
* `errorRecovery`: Boolean to skip invalid rules instead of throwing errors (default: `true` in html-minifier-next)
